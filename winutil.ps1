...
'@ | ConvertFrom-Json
$sync.configs.mogs5481_arch = @'
{
    "version":  "MOGS-5481",
    "partitions":  {
                       "C":  {
                                 "role":  "Sistema",
                                 "description":  "Windows, frameworks, apps cr??ticos, componentes que exigem C:"
                             },
                       "A":  {
                                 "role":  "Apps independentes",
                                 "description":  "Jogos e programas que n??o exigem C:, preferencialmente port??teis"
                             },
                       "D":  {
                                 "role":  "Dados pesados e tempor??rios",
                                 "description":  "TEMP/TMP, downloads, VMs, WSL, VHDX, caches pesados"
                             },
                       "S":  {
                                 "role":  "Sincroniza????o em nuvem",
                                 "description":  "OneDrive, Zoho WorkDrive, SharePoint, bibliotecas de usu??rio"
                             }
                   },
    "rules":  {
                  "temp":  "D:\\Temp",
                  "downloads":  "D:\\Downloads",
                  "browserCache":  "D:\\BrowserCache"
              }
}
'@ | ConvertFrom-Json
$sync.configs.preset = @'
